...
namespace Proyecto_LibreriaRincondelQuijote.Controllers
{
    ...
    public class EstadoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CodigoEstado,Estado_actual")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CodigoEstado,Estado_actual")] Estado estado)
        {
            if (ModelState.IsValid)
            {
